...
class EmailTemplate {
     ...
     * @returns HTML string
     */
    static verifyEmailContent(firstName, otp, duration) {
     ...
     * @returns HTML string
     */
    static welcomeContent(firstName) {
        return `<p style="margin-bottom: 1rem">
        <strong>
        Hello ${firstName},
        </strong></p>
     ...
     * @returns HTML string
     */
    static userCreationContent(firstName, role, defaultPassword) {
        return `<p style="margin-bottom: 1rem">
        <strong>
        Hello ${firstName},
        </strong></p>
     ...
     * @returns HTML string
     */
    static forgotPasswordContent(firstName, otp, duration) {
        return `<p style="margin-bottom: 1rem">
        <strong>
        Hello ${firstName},
        </strong></p>
     ...
     * @returns HTML string
     */
    static MFAContent(firstName, otp, duration) {
        return `<p style="margin-bottom: 1rem">
        <strong>
        Hello ${firstName},
        </strong></p>
     ...
     */
    static mfaStatusUpdateContent(name, status) {
        return `<p style="margin-bottom: 1rem">
        <strong>
        Hello ${name},
        </strong></p>
    ...
    static emailVerificationReminderContent(name, email, codeRequestLink) {
        return `<p style="margin-bottom: 1rem">
        <strong>
        Hello ${name},
        </strong></p>
